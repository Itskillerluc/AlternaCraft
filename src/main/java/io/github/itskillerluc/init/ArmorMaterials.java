...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    DARK_CRYSTAL("dark_crystal", 15, new int[] {3, 9, 7, 3}, 9,SoundEvents.ARMOR_EQUIP_IRON,
            0.0F, 0.0F, () -> Ingredient.of(ItemRegistry.DARK_CRYSTAL.get())),
    ...
    AIO("aio", 15, new int[] {3, 9, 7, 3}, 9,SoundEvents.ARMOR_EQUIP_IRON,
            0.0F, 0.0F, () -> Ingredient.of(ItemRegistry.AIO_CRYSTAL.get()));
